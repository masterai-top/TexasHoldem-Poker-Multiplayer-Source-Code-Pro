#ifndef __MATCH_BASIC_CONFIG_DELETE_H__
#define __MATCH_BASIC_CONFIG_DELETE_H__
class MatchBasicConfigDeleteRequest
{
public:
	MatchBasicConfigDeleteRequest(const string& json) {
...
class MatchBasicConfigDeleteResponse
{
public:
	MatchBasicConfigDeleteResponse(const string& json) {
		this->Deserialize(json);
	}
	template <typename Writer>
	void Serialize(Writer& writer) const {
